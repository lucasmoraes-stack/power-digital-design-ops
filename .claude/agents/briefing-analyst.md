...
description: Fixed, brand-agnostic front-desk agent. Reads an incoming creative demand, identifies the brand and the ask, and hands it to Copywriter and/or Designer — who already carry every onboarded brand's rules built in.
color: gold
emoji: 🎬
